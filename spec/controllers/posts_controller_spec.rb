...
RSpec.describe PostsController, type: :controller do
 ...
 # #8
  ...
  context "member user doing CRUD on a post they don't own" do                  #member on other's post
    before do
  ...
  context "member user doing CRUD on a post they own" do                        # member's post
    before do
  ...
  context "moderator user doing CRUD on a post they don't own" do                   # moderator on post
   before do
  ...
  context "admin user doing CRUD on a post they don't own" do                   # admin on post
   before do
     other_user.admin!
     create_session(other_user)
   end
