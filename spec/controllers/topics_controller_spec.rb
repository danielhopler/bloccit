...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do                                    # Member user
    before do
  ...
  context "admin user" do                                    # Admin user
    before do
  ...
  context "moderator user" do                                    # Moderator user
    before do
